...
<head>
    ...
    <link rel="" href="{{ asset('uploads/settings/logo') }}">
    <!-- Bootstrap CSS -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="{{ asset('uploads/courses/logo.png') }}" alt="logo"> </a>
...
<section class="cta">
  ...
  <div class="row">
        <div class="col-12  pb-5">
          <h2 class="contact-title  pb-5">Register at school math et phisique</h2>
        </div>
        <div class="col-lg-8 ">
                ...
                <div class="col-sm-6 col-md-4 col-xl-4">
                    <div class="single-footer-widget footer_2">
                        ...
                        <div class="social_icon">
                            <a href="fc"> <i class="ti-facebook"></i> </a>
                            <a href="adress"> <i class="ti-adress"></i> </a>
                            <a href="phone"> <i class="ti-phone"></i> </a>
                           </div>
                    </div>
                </div>
